      ...
      <div className="hero-content grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <p className="py-6 text-gray-300">
            ...
            everyone's taste. Hire a tricycle from Danny’s Trike Tours and
            explore the surrounding trails then grab a refreshing drink at The
            Redrum Bar. If relaxation is more your style, why not treat yourself
            to a day of pampering at The Green Lady spa, because you've earned
            it.
          </p>
